...
Two point particles are separated by a distance of $60\,\text{cm}$ and carry a total charge of $200\,\mu\text{C}$. Determine the charge of each of the two particles if they
...
Thus,
\[
|q_1 q_2| = \frac{F r^2}{k} \approx 3.2\times 10^{-9}\,\text{C}^2,
\]
with
\[
q_1 q_2 = q_1 (q - q_1).
...
\item
\[
q_1 q_2 = +3.2\times 10^{-9} \Rightarrow x^2 - (200\times 10^{-6})x + 3.2\times 10^{-9} = 0
\]
With
\[
...
\]
\[
q_1 \approx 1.8\times 10^{-4}\,\text{C},\quad
q_2 \approx 1.8\times 10^{-5}\,\text{C}.
\]
...
\]
\[
q_1 \approx -1.5\times 10^{-5}\,\text{C},\quad
q_2 \approx 2.1\times 10^{-4}\,\text{C}.
\]
\end{enumerate}
\end{solution}
\fi
...
A particle accelerator produces a proton beam with a current of $3.5 \,\mu\mathrm{A}$. Each proton has an energy of $60 \,\mathrm{MeV}$. The protons strike a target in a vacuum chamber and come to rest in it, heating the target.
\begin{enumerate}[label=\alph*)]
...
\ifshowsolutions
\begin{solution}
The beam current is $I = 3.5 \,\mu\mathrm{A} = 3.5\times 10^{-6} \,\mathrm{A}$.
The elementary charge is $e = 1.602\times 10^{-19} \,\mathrm{C}$.
...
Substituting,
\[
\dot{N} = \frac{3.5\times 10^{-6}}{1.602\times 10^{-19}} \,\mathrm{s}^{-1} \approx 2.18\times 10^{13} \,\mathrm{s}^{-1}.
\]
\item Each proton has an energy of $60 \,\mathrm{MeV}$.
