...
\[
\underline{S} = \underline{v}_s \underline{i}_s^* = (31.12 + j\,2.94)\,\text{VA}.
\]

\item Active power delivered by source:
\[
P = \Re\{\underline{S}\} = 31.12\,\text{W}
\]

\item Reactive power:
\[
Q = \Im\{\underline{S}\} = 2.94\,\text{VAR}
\]
...
\[
\text{pf}=\dfrac{P}{S} = \dfrac{31.12}{31.26} \approx 0.9956.
\]
