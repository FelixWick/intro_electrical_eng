...
\begin{tcolorbox}[enhanced, breakable, colback=gray!10!white,
  ...
  title={Exercise Sheet \#4}, sharp corners, width=\textwidth]
\begin{center}
  Fields 1
\end{center}
\end{tcolorbox}
