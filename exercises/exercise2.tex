...
\ifshowsolutions
\begin{solution}
First, we calculate the equivalent resistance of the paralles resistors with $3\, \Omega$ and $6\, \Omega$, then we add the series resistor with $8\, \Omega$:
...
\ifshowsolutions
\begin{solution}
First, we calculate the equivalent resistance of the paralles resistors with $1\, \Omega$ and $2\, \Omega$ and call it \(R_3\):
